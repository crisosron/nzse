...
const GeneralPage = ({
  ...
  return (
    <Layout>
      <div className="GeneralPage flex grow">
        ...
        <div className="content prose md:prose-lg lg:prose-lg lg:py-4 lg:mx-8 lg:max-w-full md:flex md:flex-col md:grow md:justify-center">
