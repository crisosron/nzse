...
const Sidebar = ({ navBlocks, className }) => {
  ...
  return (
    <div className={`Sidebar p-5 bg-light-blue-100 md:p-10 md:bg-white md:border-r-2 md:border-gray md:min-w-40 md:flex md:flex-col lg:py-16 lg:min-w-48 ${className}`}>
