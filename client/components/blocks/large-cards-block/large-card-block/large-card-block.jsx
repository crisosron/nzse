  ...
  return (
    <Link href={url}>
      <a className='LargeCardBlock card-block mb-8 md:mb-0 w-full h-[25em] last:mb-0 md:mr-4 lg:mr-8 md:last:mr-0 flex flex-col shadow-lg transition-all duration-500 hover:shadow-xl font-poppins group'>
        ...
        <div className='overflow-hidden transition-all duration-500 flex flex-1 items-center px-5 py-5 md:py-0 text-dark-blue group-hover:bg-light-blue group-hover:text-white group-hover:decoration-2'>
